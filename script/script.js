$(document).ready(function () {
  ...
  // Sets the inital page display of the map in the background. Hard Coded a random location into it
  var map, infoWindow;
  ...
  $("#searchAgain").on("click", function () {
    ...
    restaurantRatings.attr("data-rating", results[i].restaurant.user_rating.aggregate_rating);
    restaurantRatings.text("Rating: " + results[i].restaurant.user_rating.aggregate_rating);

    // Append results.restaurant info to var a (links)
    URL.append(restaurantHighlights, restaurantRatings, restaurantName, restaurantCuisines);
