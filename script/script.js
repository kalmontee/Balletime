$(document).ready(function() {
    ...
    $("#searchAgain").on("click", function() {
        ...
        // This will grab each restaurant URL
        var a = $('<a>');

        // target the results.restaurant.cuisines
        var p1 = $('<p>');

        // This will target the results.restaurant.highlights
        var p = $('<p>');

        // This will target the results.restairant.ratings
        var p2 = $('<p>');

        // Name will target the names of the restaurant
        var name = $('<h4>');
